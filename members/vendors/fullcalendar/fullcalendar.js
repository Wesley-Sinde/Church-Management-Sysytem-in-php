...
*/
    ...
    function MonthView(element, calendar) {
        ...
        function render(date, delta) {
            ...
            addDays(
                visStart, -((visStart.getDay() - Math.max(firstDay, nwe) + 7) % 7)
            );
    ...
    function BasicWeekView(element, calendar) {
        ...
        function render(date, delta) {
            ...
            var start = addDays(
                cloneDate(date), -((date.getDay() - opt("firstDay") + 7) % 7)
            );
	...
	----------------------------------------------------------------------------*/
        ...
        function compileDaySegs(events) {
            var levels = stackSegs(
                    sliceSegs(events, $.map(events, exclEndDay), t.visStart, t.visEnd)
                ),
                i,
	...
	-----------------------------------------------------------------------------------*/
                ...
                stop: function(ev, ui) {
                    ...
                    if (revert) {
                        ...
                        if (!allDay) {
                            minuteDelta =
                                Math.round(
                                    (eventElement.offset().top - getBodyContent().offset().top) /
                                    slotHeight
                                ) *
                                opt("slotMinutes") +
                                minMinute -
        ...
        function draggableSlotEvent(event, eventElement, timeElement) {
            ...
            eventElement.draggable({
                ...
                drag: function(ev, ui) {
                    minuteDelta =
                        Math.round((ui.position.top - origPosition.top) / slotHeight) *
                        opt("slotMinutes");
            ...
            eventElement.resizable({
                ...
                resize: function(ev, ui) {
                    ...
                    if (slotDelta != prevSlotDelta) {
                        timeElement.text(
                            formatDates(
                                event.start, !slotDelta && !event.end ?
    ...
    function View(element, calendar, viewName) {
        ...
        function trigger(name, thisObj) {
            return calendar.trigger.apply(
                calendar, [name, thisObj || t].concat(Array.prototype.slice.call(arguments, 2), [
                    t,
                ])
            );
        }
