...
(function(m, ma) {
    ...
    function Fa(a, b, e) {
        for (
            b = b || 1; !a.getDay() || (e && a.getDay() == 1) || (!e && a.getDay() == 6);
            ...
            s.resizable({
                ...
                resize: function(M, k) {
                    ...
                    if (F != r) {
                        v.text(
                            W(
                                o.start, !F && !o.end ? null : xa(ra(o), u("slotMinutes") * F),
                                u("timeFormat")
                            )
                        );
                        r = F;
    ...
    function Kb(a, b, e) {
        ...
        function f(G, p) {
            return b.trigger.apply(
                b, [G, p || da].concat(Array.prototype.slice.call(arguments, 2), [da])
            );
        }
    ...
    function Lb() {
        ...
        function b() {
            for (var g;
                (g = d.shift());) f.push(g.hide().unbind());
        }
        var e = this;
        e.renderOverlay = a;
        e.clearOverlays = b;
