...
function startElement($parser, $name, $attribs) //opening, i.e. <COMMENT>
{
  ...
  if (($name == "BROWSERTITLE") || ($name == "SLIDETITLE") || ($name == "DESCRIPTION") || ($name == "KEYWORDS")) {
    global $current;
